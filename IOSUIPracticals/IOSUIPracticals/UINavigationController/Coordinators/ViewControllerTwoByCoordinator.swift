//
//  SecondViewControllerByCoordinator.swift
//  IOSUIPracticals
//
...
extension ViewControllerTwoByCoordinator: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tblView.dequeueReusableCell(withIdentifier: "RecievedItemTableViewCell") as? RecievedItemTableViewCell else {
            return UITableViewCell()
        }
        cell.tableViewItems.text = recievedItems[indexPath.row]
        return cell
    }
